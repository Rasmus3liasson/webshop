        ...
        {cartData !== null && cartData.length > 0 ? (
          <>
            ...
            <button
              ...
              className="text-md bg-black text-white p-3 rounded-3xl hover:scale-102 hover:opacity-90 duration-200 active:scale-98 flex items-center gap-2"
            >
              Till betalning
              {isLoading && (
                <span className="animate-pulse">
                  <svg
                    aria-hidden="true"
                    className="w-6 h-6 mr-2 animate-spin fill-white text-grey"
                    viewBox="0 0 100 101"
                    fill="none"
